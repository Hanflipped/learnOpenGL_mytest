...
//-------------
  ...
  glm::vec3 view_traslate = glm::vec3(0.0, 0.0, 1.0);
  ImVec4 clean_color = ImVec4(0.1, 0.1, 0.1, 1.0);
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    ImGui::SliderFloat("x", &view_traslate.x, -10.0, 10.0);
    ImGui::SliderFloat("y", &view_traslate.y, -10.0, 10.0);
    ImGui::SliderFloat("z", &view_traslate.z, -10.0, 10.0);
    
    ImGui::ColorEdit3("clear color", (float*)&clean_color);
    ImGui::End();

    // 渲染指令
    // ...
    glClearColor(clean_color.x, clean_color.y, clean_color.z,clean_color.w);
    ...
    view = glm::translate(view, view_traslate);
